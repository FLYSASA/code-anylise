	...
	<sapi-dialog v-model="visible" width="700px" top="15%" @on-close="close" @on-open="open">
		...
		<div class="form-content no-footer">
			<ul class="log-detail-list">
				...
				<li class="fullline">
					<div class="wp-50">
						<span class="w-75">异常类型</span>
						<div class="right-view-box">
							<el-input v-model="viewModel.TypeName" :maxlength="200" readonly></el-input>
						</div>
					</div>
					<div class="wp-50 float-right">
				...
				<li class="fullline">
					<span class="w-75">访问地址</span>
					<div class="right-view-box">
						<el-input v-model="viewModel.Source" :maxlength="200" readonly></el-input>
					</div>
				</li>
				<li class="fullline">
					<span class="w-75">异常消息</span>
					<div class="right-view-box">
						<el-input type="textarea" v-model="viewModel.Message" :rows="2" :maxlength="200" readonly></el-input>
					</div>
				</li>
				<li class="fullline">
					<span class="w-75">异常跟踪</span>
					<div class="right-view-box">
						<el-input type="textarea" v-model="viewModel.StackTrace" :rows="8" :maxlength="200" readonly></el-input>
					</div>
				</li>
				<li class="fullline">
					<div class="wp-50">
						<span class="w-75">异常发生时间</span>
						<div class="right-view-box">
							<el-input v-model="exceptionTime" :maxlength="200" readonly></el-input>
						</div>
					</div>
					<div class="wp-50 float-right">
...
<script>
	...
	export default {
		...
		computed:{
			...
			exceptionTime(){
				if (this.viewModel.ExceptionTime) {
					return this.viewModel.ExceptionTime.replace(/T/g,' ');
				}
			}
		},
		components: {
