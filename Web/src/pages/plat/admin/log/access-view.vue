	...
	<sapi-dialog v-model="visible" width="700px" top="15%" @on-close="close" @on-open="open">
		...
		<div class="form-content">
			<ul class="log-detail-list">
				...
				<li class="fullline">
					<div class="wp-50">
						<span class="w-75">访问时间</span>
						<div class="right-view-box">
							<el-input v-model="accessTime" :maxlength="200" readonly></el-input>
						</div>
					</div>
					<div class="wp-50 float-right">
...
<script>
	...
	export default {
		...
		computed:{
			...
			accessTime(){
				if (this.viewModel.AccessTime) {
					return this.viewModel.AccessTime.replace(/T/g,' ');
				}
			}
		},
		components: {
