...
import Vue from 'vue'
import { Group, Cell, Box, Icon, WechatEmotion as Emotion, Divider, ToastPlugin } from 'vux'
import xIconDemo from './xiconDemo.vue'
...
new Vue({
    el: '#app',
    components: { Group, Cell, Box, Icon, Emotion, Divider, xIconDemo },
    data: {
